...
int main() {
    ...
    assert(_num_allocated_bytes() == 21010);
    ...
    assert(_num_allocated_bytes() == 21011);
    ...
    assert(_num_allocated_bytes() == 21013);
   ...
   std::cout << "YOU PASSED AND YOU ARE AWESOME!" << std::endl; 
